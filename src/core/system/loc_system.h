 ...
 * @Date: 2025-11-17 10:41:10
 * @LastEditors: nuc 1078456645@qq.com
 * @LastEditTime: 2025-11-25 16:33:29
 * @FilePath: /lightning-lm_ws/src/lightning-lm/src/core/system/loc_system.h
...
class LocSystem {
   ...
   private:
    ...
    rclcpp::Subscription<geometry_msgs::msg::PoseWithCovarianceStamped>::SharedPtr init_pose_sub = nullptr;
};
