...
class LaserMapping {
   public:
     ...
     * @return
     */
    CloudPtr GetGlobalMap(bool use_lio_pose, bool use_voxel = false, float res = 0.1);
   ...
   private:
    ...
    // global map
    double global_map_filter_in_ego_z_min = 0.0;
    double global_map_filter_in_ego_z_max = 0.0;
