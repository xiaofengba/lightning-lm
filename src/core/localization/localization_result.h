 ...
 * @LastEditTime: 2025-11-26 09:37:57
 * @FilePath: /lightning-lm_ws/src/lightning-lm/src/core/localization/localization_result.h
...
struct LocalizationResult {
    ...
    geometry_msgs::msg::TransformStamped ToGeoMsg(std::string child_frame_id) const;  // 转到geometry msg
